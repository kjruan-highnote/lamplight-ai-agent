...
This ensures consistency between what's in Postman and what the MCP server uses.
"""
...
class PostmanToOperationsSync:
    ...
    def __init__(self, postman_dir: Path, operations_dir: Path):
        self.postman_dir = Path(postman_dir)
...
def main():
    ...
    parser.add_argument('--postman-dir', 
                       default='../agents/ship-agent/data/postman',
                       help='Directory containing Postman collections')
    parser.add_argument('--operations-dir',
                       default='../agents/ship-agent/data/operations',
    ...
    syncer = PostmanToOperationsSync(
        Path(args.postman_dir),
        Path(args.operations_dir)
    )
    
    if args.collection:
        # Sync specific collection
        postman_file = Path(args.postman_dir) / f"{args.collection}.json"
